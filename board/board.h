...
#define BOARD_LCD_RESET_GPIO_BASE      HPM_GPIO0
#define BOARD_LCD_RESET_GPIO_INDEX     GPIO_DO_GPIOB
#define BOARD_LCD_RESET_GPIO_PIN       16
...
#define BOARD_LCD_POWER_EN_GPIO_BASE   HPM_GPIO0
#define BOARD_LCD_POWER_EN_GPIO_INDEX  GPIO_DO_GPIOZ
#define BOARD_LCD_POWER_EN_GPIO_PIN    00
...
#define BOARD_APP_SDIO_POWER_SWITCH_PIN IOC_PAD_PC20
#endif

#define BOARD_APP_SDIO_WIFI_OOB_PORT       (HPM_GPIO0)
#define BOARD_APP_SDIO_WIFI_OOB_PIN        (IOC_PAD_PD24)
#define BOARD_APP_SDIO_WIFI_OOB_IRQ        IRQn_GPIO0_D
#define BOARD_APP_SDIO_WIFI_WL_REG_ON_PORT (HPM_GPIO0)
#define BOARD_APP_SDIO_WIFI_WL_REG_ON_PIN  (IOC_PAD_PD19)
...
#define BOARD_GPTMR_I2S_MCLK          HPM_GPTMR3
#define BOARD_GPTMR_I2S_MCLK_CHANNEL  1
#define BOARD_GPTMR_I2S_MCLK_CLK_NAME clock_gptmr3
