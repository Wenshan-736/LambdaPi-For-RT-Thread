...
void init_uart_pins(UART_Type *ptr)
{
    if (ptr == HPM_UART0) {
        ...
        /* UART1 */
        HPM_IOC->PAD[IOC_PAD_PE22].FUNC_CTL = IOC_PE22_FUNC_CTL_UART1_RXD;
        HPM_IOC->PAD[IOC_PAD_PE23].FUNC_CTL = IOC_PE23_FUNC_CTL_UART1_TXD;
...
void init_lcd_pins(LCDC_Type *ptr)
{
    ...
    HPM_GPIO0->OE[GPIO_OE_GPIOZ].SET = 1 << 0;
    HPM_GPIO0->DO[GPIO_OE_GPIOZ].SET = 1 << 0;
}
...
void init_i2c_pins(I2C_Type *ptr)
{
    if (ptr == HPM_I2C0) {
        ...
        HPM_IOC->PAD[IOC_PAD_PZ10].FUNC_CTL = IOC_PZ10_FUNC_CTL_I2C0_SDA
                                            | IOC_PAD_FUNC_CTL_LOOP_BACK_MASK;
        /* PZ port IO needs to configure BIOC as well */
        HPM_BIOC->PAD[IOC_PAD_PZ11].FUNC_CTL = 3;
        HPM_BIOC->PAD[IOC_PAD_PZ10].FUNC_CTL = 3;
        ...
        /* I2C1 */
        HPM_IOC->PAD[IOC_PAD_PA11].FUNC_CTL = IOC_PA11_FUNC_CTL_I2C1_SCL | IOC_PAD_FUNC_CTL_LOOP_BACK_MASK;
        HPM_IOC->PAD[IOC_PAD_PA11].PAD_CTL = IOC_PAD_PAD_CTL_OD_SET(1) | IOC_PAD_PAD_CTL_PE_SET(1) | 0x08 | IOC_PAD_PAD_CTL_PS_SET(1);
        HPM_IOC->PAD[IOC_PAD_PA10].FUNC_CTL = IOC_PA10_FUNC_CTL_I2C1_SDA;
        HPM_IOC->PAD[IOC_PAD_PA10].PAD_CTL = IOC_PAD_PAD_CTL_OD_SET(1) | IOC_PAD_PAD_CTL_PE_SET(1) | 0x08 | IOC_PAD_PAD_CTL_PS_SET(1);
    } else if(ptr == HPM_I2C3){
        /* I2C3 */
        ...
        HPM_IOC->PAD[IOC_PAD_PB14].PAD_CTL = IOC_PAD_PAD_CTL_OD_SET(1) | IOC_PAD_PAD_CTL_PE_SET(1) | 0x08 | IOC_PAD_PAD_CTL_PS_SET(1);
        HPM_IOC->PAD[IOC_PAD_PB13].PAD_CTL = IOC_PAD_PAD_CTL_OD_SET(1) | IOC_PAD_PAD_CTL_PE_SET(1) | 0x08 | IOC_PAD_PAD_CTL_PS_SET(1);
    }
}
...
{
    if (ptr == HPM_SPI0) {
        HPM_IOC->PAD[IOC_PAD_PA05].FUNC_CTL = IOC_PA05_FUNC_CTL_SPI0_CSN;
        HPM_IOC->PAD[IOC_PAD_PA02].FUNC_CTL = IOC_PA02_FUNC_CTL_SPI0_MISO;
        HPM_IOC->PAD[IOC_PAD_PA06].FUNC_CTL = IOC_PA06_FUNC_CTL_SPI0_MOSI;
        HPM_IOC->PAD[IOC_PAD_PA01].FUNC_CTL = IOC_PA01_FUNC_CTL_SPI0_SCLK | IOC_PAD_FUNC_CTL_LOOP_BACK_MASK;

        HPM_IOC->PAD[IOC_PAD_PA05].PAD_CTL = IOC_PAD_PAD_CTL_DS_SET(6) | IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1);
        HPM_IOC->PAD[IOC_PAD_PA02].PAD_CTL = IOC_PAD_PAD_CTL_DS_SET(6) | IOC_PAD_PAD_CTL_PE_SET(1);
        HPM_IOC->PAD[IOC_PAD_PA06].PAD_CTL = IOC_PAD_PAD_CTL_DS_SET(6) | IOC_PAD_PAD_CTL_PE_SET(1);
        HPM_IOC->PAD[IOC_PAD_PA01].PAD_CTL = IOC_PAD_PAD_CTL_DS_SET(6) | IOC_PAD_PAD_CTL_PE_SET(1);
        ...
        HPM_IOC->PAD[IOC_PAD_PE03].PAD_CTL = IOC_PAD_PAD_CTL_DS_SET(6) | IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1);
        HPM_IOC->PAD[IOC_PAD_PE04].PAD_CTL = IOC_PAD_PAD_CTL_DS_SET(6) | IOC_PAD_PAD_CTL_PE_SET(1);
        HPM_IOC->PAD[IOC_PAD_PD31].PAD_CTL = IOC_PAD_PAD_CTL_DS_SET(6) | IOC_PAD_PAD_CTL_PE_SET(1);
        HPM_IOC->PAD[IOC_PAD_PD30].PAD_CTL = IOC_PAD_PAD_CTL_DS_SET(6) | IOC_PAD_PAD_CTL_PE_SET(1);
...
void init_can_pins(CAN_Type *ptr)
{
    if (ptr == HPM_CAN0) {
        ...
        /* CAN1 */
        HPM_IOC->PAD[IOC_PAD_PD16].FUNC_CTL = IOC_PD16_FUNC_CTL_CAN1_TXD;
        HPM_IOC->PAD[IOC_PAD_PD19].FUNC_CTL = IOC_PD19_FUNC_CTL_CAN1_RXD;
...
void init_sdxc_cd_pin(SDXC_Type  *ptr, bool as_gpio)
{
    ...
    if (ptr == HPM_SDXC1) {
        if (as_gpio) {
            /* SDXC1.CDN */
            uint32_t cd_func_alt = IOC_PD28_FUNC_CTL_GPIO_D_28;
...
void init_sdxc_pwr_pin(SDXC_Type *ptr, bool as_gpio)
{
    if (ptr == HPM_SDXC1) {
        if (as_gpio) {
            ...
            HPM_IOC->PAD[IOC_PAD_PF01].PAD_CTL =
                    IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_DS_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1);
//            gpiom_set_pin_controller(HPM_GPIOM, GPIOM_ASSIGN_GPIOF, 1, gpiom_soc_gpio0);
            gpio_set_pin_output(HPM_GPIO0, GPIO_OE_GPIOF, 1);
            gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOF, 1, 1);
        }
    }
}
